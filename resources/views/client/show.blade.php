                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      ...
                      <div class="col-auto text-right">
                        ...
                        <p class="text-muted font-weight-bold">Not Available</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-12 mb-4">
              <div class="card o-hidden border-0 shadow h-100 py-2">
                <div class="card-body text-center">
                  <h3 class="text-gray-900 font-weight-bold">Ticket Not Available</h3>
                  <p class="text-muted">Try to search other ticket.</p>
