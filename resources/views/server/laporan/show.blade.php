...
@section('content')
  <div class="row justify-content-center" style="margin-bottom: 35px;">
    ...
    <div class="col-12" style="margin-top: -15px">
      <a href="javascript:window.history.back();" class="text-white btn"><i class="fas fa-arrow-left mr-2"></i> Return</a>
    @else
    <div class="col-12">
    @endif
      <div class="card shadow h-100" style="border-top: .25rem solid #4e73df">
        <div class="card-body">
          <div class="row no-gutters align-items-center justify-content-center">
            <div class="col h5 font-weight-bold" style="margin-bottom: 0">Travel Detail</div>
            <div class="col-auto">
              <span class="title">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center justify-content-center">
            <div class="col">
              <p style="margin-bottom: 0">Booking Number</p>
          ...
          <p style="margin-bottom: 0; margin-top: 5px;">Depart Time</p>
        ...
        @if ($data->status == "Belum Bayar" && Auth::user()->level != "Penumpang")
          <div class="card-body">
            <a href="{{ route('pembayaran', $data->id) }}" class="btn btn-primary btn-block btn-sm text-white">Verification</a>
          </div>
        @endif
      </div>
    </div>
