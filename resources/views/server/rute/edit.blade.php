  ...
  <div class="card shadow mb-4 mt-2">
    <form action="{{ route('rute.store') }}" method="POST">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          <label for="start">Start Route</label>
          <input
            type="text"
            class="form-control"
            id="start"
        ...
        <div class="form-group">
          <label for="end">Finish Route</label>
          <input
            type="text"
            class="form-control"
            id="end"
        ...
        <div class="form-group">
          <label for="jam">Depart Time</label>
          <input
            type="time"
            class="form-control"
            id="jam"
        ...
        <div class="form-group">
          <label for="transportasi_id">Transportation</label><br>
          <select
      ...
      <div class="card-footer">
        <a href="{{ route('rute.index') }}" class="btn btn-warning mr-2">Back</a>
