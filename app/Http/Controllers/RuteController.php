...
class RuteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->id) {
            return redirect()->route('rute.index')->with('success', 'Update Route Success!');
        } else {
            return redirect()->back()->with('success', 'Add Route Success!');
        }
    }
    ...
    {
        Rute::find($id)->delete();
        return redirect()->back()->with('success', 'Delete Route Success!');
    }
}
