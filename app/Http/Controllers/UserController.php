...
class UserController extends Controller
{
    ...
    public function name(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Name changed succesfully!');
    }
        ...
        if ($request->password_lama == true) {
            if (Hash::check($request->password_lama, $user->password)) {
                if ($request->password_lama == $request->password) {
                    return redirect()->back()->with('error', 'Sorry, your last password and new password are same!');
                } else {
                    $user_password = [
                        'password' => Hash::make($request->password),
                    ];
                ...
                return redirect()->back()->with('error', 'Please input your last password correctly!');
            }
        } else {
            return redirect()->back()->with('error', 'Please input your last password first!');
        }
    }
}
